...
import { Code, Database, Server, Layout, GitBranch, Terminal, Layers, Cpu, Globe, Workflow, Icon, Network, Cloud } from "lucide-react"
...
const skills = [
  ...
  {
    icon: Network,
    name: "Network Administration & Security",
    tech: "Routing, Switching, Firewall, VPN, Network Security",
    description: "Designing and implementing efficient network architectures for reliable communication.",
    color: "text-blue-500",
  },
  // {
  //   icon: Workflow,
  ...
  // },
  {
    ...
    tech: "AWS, Microsoft Azure, Docker",
    description: "Working efficiently in agile environments with focus on continuous delivery.",
    color: "text-cyan-500",
  },
]
