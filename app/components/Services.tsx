...
import { Brain, BrainCircuit, Cloud, Code, Layout, Network, Server, Smartphone } from "lucide-react"
...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Robust and scalable server-side solutions using Node.js, Express, Python and PHP.",
    },
    {
    ...
    },
    {
      ...
      description: "Developing AI solutions using Python, tensorflow, pytorch and openAI for business intelligence and automation.",
    },
    {
      icon: <Cloud className="w-12 h-12 text-cyan-500" />,
      title: "Cloud & DevOps Solutions",
      description: "Deploying, managing, and scaling applications using AWS, Microsoft Azure, Docker, and CI/CD pipelines.",
    },
    // {
    ...
    // },
    {
      ...
      description: "Setting up and managing networks, firewalls, VLANs, and IT infrastructure for businesses.",
    }
  ]
